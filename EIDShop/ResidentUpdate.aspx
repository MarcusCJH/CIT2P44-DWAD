<%@ Page Title="" Language="C#" MasterPageFile="~/EIDShopMaster.Master" AutoEventWireup="true" CodeBehind="ResidentUpdate.aspx.cs" Inherits="EIDShop.ResidentUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        Resident Management » <a href="ResidentManagement.aspx">Overview</a> » <a class="active" href="ResidentCreate.aspx">Edit</a></h2>
                        <div id="main">
                	<form action="" class="jNice">
					<h3>Edit section</h3>
                    	<fieldset>
                        	<p><label>Name:</label>*<asp:TextBox ID="txbName" class="text-long" runat="server"></asp:TextBox>
                            ...
                            <p><label>Address</label>*<asp:TextBox ID="tbxaddress" 
                                    runat="server" Height="51px" TextMode="MultiLine" 
                            ...
                            <p><label>Birthday</label> *<asp:TextBox ID="tbxYear" name="Year" value="Year" onfocus="if(value == defaultValue){value='';this.style.color='#000'}" onblur="if(!value){value = defaultValue;this.style.color='#999'}" class="text-medium" runat="server"></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                    ControlToValidate="tbxMouth" Display="Dynamic" 
...
&nbsp;&nbsp;&nbsp;
                        	...
                        	<p><label>Description of disability        <asp:TextBox ID="tbxDes" class="textarea" runat="server" Columns="1" Rows="1"
