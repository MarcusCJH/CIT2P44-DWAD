...
namespace EIDShop
{
    public partial class Createupdateform : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            vol.StaffNo = (int)Session["staff_no"];

            if (EIDdbVolunteerManagement.InsertVol(vol, vol.StaffNo) == 1)
            {
                int maxId = EIDdbVolunteerManagement.RetrieveMaxID();
                Response.Redirect("VolunteerViewpage.aspx?volunteerNo="+maxId);
            }
        }
