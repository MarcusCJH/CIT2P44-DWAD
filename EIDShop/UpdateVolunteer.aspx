<%@ Page Title="" Language="C#" MasterPageFile="~/EIDShopMaster.Master" AutoEventWireup="true" CodeBehind="UpdateVolunteer.aspx.cs" Inherits="EIDShop.UpdateVolunteer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>
        ...
        <a class="active" href="UpdateVolunteer.aspx">Update</a></h2>
    <div id="main">
        <h3>
            Update Section</h3>
        <fieldset>
            <p>
                <label>
                Volunteer Idenfication</label><asp:Label ID="lblVolID" runat="server"></asp:Label>
            </p>
            <p>
                <label>
